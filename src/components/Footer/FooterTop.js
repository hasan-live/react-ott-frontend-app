    ...
    return (
        <>
              <section class="footer px-20 py-10  bg-accent text-base-100">
                <div className='mx-auto'>
                    <div class="mb-6 md:mb-0">
                        <a href="#" class="flex items-center">
                            ...
                            <span class="self-center text-2xl font-bold whitespace-nowrap dark:text-white ml-2">OTT</span>
                        </a>
                    </div>
                ...
                <div>
                    <span class="text-2xl text-bold">Quick Links</span>
                ...
                <div>
                    <span class="text-2xl text-bold">Movie Categories +</span>
                ...
                <div>
                    <span class="text-2xl text-bold">Categories</span>
                ...
                <Link to='/' class="p-8 text-left bg-local bg-gray-500 bg-center bg-no-repeat bg-cover rounded-lg bg-blend-multiply hover:bg-blend-soft-light dark:hover:bg-blend-darken">
                    ...
                    <div class="justify-center items-center space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
                        <Link to='/' class="w-full sm:w-auto bg-gray-800 hover:bg-gray-700 focus:ring-4 focus:outline-none focus:ring-gray-300 text-white rounded-lg inline-flex items-center justify-center px-4 py-2.5 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700">
