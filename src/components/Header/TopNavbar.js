    ...
    <>
      {/* <div class="drawer">
        ...
        <div class="drawer-content flex flex-col">
          ...
          <div class="w-full navbar bg-gray-800 text-white">
            ...
            <div class="flex flex-1 px-2 mx-2 text-2xl font-bold items-center">OTT</div>

            <div class="flex hidden lg:block md:hidden flex-1 mr-48">
              <form>
                ...
                <div class="relative">
                  ...
                  <input type="search" id="default-search" class="block p-4 pl-10 w-full text-sm text-gray-900 bg-black rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search" required="" />
            ...
            <div class="flex-none hidden lg:block">
              <ul class="menu menu-horizontal">
                <li className='border'><a>Home</a></li>
                <li><a>Movies</a></li>
                <li><a> Live
                </a></li>
                <li><a>TV Shows
                ...
                <li><a><button class="btn btn-error gap-2">
                  Sign In
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
