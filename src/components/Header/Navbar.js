...
const Navbar = () => {
    const menuItems =
        <>
            ...
            <li>< Link to='/mylist' className='sm:mt-px'>My List</Link></li>

        </>
    return (
        <>
            <div class="navbar bg-accent text-base-100">
                ...
                <div class="navbar-end">
                    <a class="btn button lowercase">Sign In <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 ml-2" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
