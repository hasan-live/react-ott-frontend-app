                        ...
                        images.map((image, index) => (
                            <div class="p-2 lg:w-1/4 md:w-1/3 p-6">
                                ...
                                <div className='relative  brightness-100 hover:brightness-60 '>
                                        <a href="#" class="group h-96 md:h-53 block  rounded-lg overflow-hidden shadow-lg relative mb-2 lg:mb-3 brightness-100 hover:brightness-50">
                                            <img src={image} loading="lazy" alt="Movie" class="w-full h-full object-cover object-center group-hover:scale-105 transition duration-200" />
                                            <span class="bg-red-500 text-white text-sm  font-bold uppercase rounded-br-lg absolute left-0 top-10 px-3 py-1.5 hover:opacity-0">New</span>

                                            <div class="absolute top-0 left-0  w-full h-full flex justify-center items-center opacity-0 hover:opacity-1 hover:opacity-100  hover:brightness-100 ">
                                                <a href='#' class="relative flex items-center justify-center  w-min flex-shrink-0 p-2 text-center text-primary  rounded-full group-hover:primary text-white text-5xl bg-primary group-hover:stroke-white" >
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="white" viewBox="0 0 24 24" stroke-width="1.7" stroke="currentColor" class="w-12 h-12  ml-1 mx-auto">
