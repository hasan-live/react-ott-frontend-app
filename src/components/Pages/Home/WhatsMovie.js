            ...
            <div class="my-5">
                <div class="max-w-screen-2xl px-4 md:px-4 mx-auto">
                    <section class="flex flex-col lg:flex-row justify-between gap-6 sm:gap-10 md:gap-4 mb-8 md:mb-8">
                        <div class="xl:w-7/12 md:w-8/12 flex flex-col justify-center sm:text-center lg:text-left lg:py-6">
                                        ...
                                        <div className='flex justify-between items-center'>
                                            <div className='flex lg:justify-center lg:items-center'>
                                               <><img src={whatsonplay}  className='w-10 h-10'/></>
                                                <div className='lg:ml-4 ml-1 text-white text-xl '>
                                                    ...
                                                    <div>
                                                        <ul class="flex justify-around text-white-700 text-sm lg:text-xl font-bold ">
                                            ...
                                            <div className='flex justify-start  items-center '>
                                                <div className=' lg:ml-3 ml-0 text-white text-sm lg:text-xl '>
                                                    ...
                                                    <div>
                                                        <h2 class="text-white-700 text-lg lg:text-xl font-bold mb-3 ">345  Reviews</h2>
                                                    </div >
                                                </div>
                                                <div className='ml-5 btn btn-square bg-white'><svg xmlns="http://www.w3.org/2000/svg" fill="red" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-8 h-8">
                        ...
                        <div class="h-full grid grid-cols-2 md:grid-cols-3 gap-8  my-10 md:mt-15 ">
                            <div className='flex justify-center items-center'>
                                <a href="#" class=" flex items-center transition ease-in-out delay-150 bg-text hover:-translate-y-1 hover:scale-105 hover:bg duration-30 ">
