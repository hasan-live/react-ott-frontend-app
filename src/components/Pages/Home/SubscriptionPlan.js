                ...
                <div class="container mx-auto px-4">
                    ...
                    <div class="shadow-lg lg:mx-[40px] md:flex items-center justify-center gap-6  md:mt-6">
                        ...
                        <div class=" lg:w-1/3 my-2 md:my-6 ">
                            <div class="shadow-lg border-4 border-solid border-gray text-center max-w-sm mx-auto rounded-3xl  transition-colors duration-300 transition ease-in-out delay-150 bg-text hover:-translate-y-1 hover:scale-108 hover:bg duration-30">
                        ...
                        <div class=" lg:w-1/3 my-2 md:my-6 ">
                            <div class="shadow-lg border-4 border-solid border-gray text-center max-w-sm mx-auto rounded-3xl md:scale-105 duration-300 transition ease-in-out delay-150 bg-text hover:-translate-y-1 hover:scale-108 hover:bg duration-30">
                        ...
                        <div class=" lg:w-1/3 my-2 md:my-6 ">
                            <div class="shadow-lg border-4 border-solid border-gray text-center max-w-sm mx-auto rounded-3xl duration-300 transition ease-in-out delay-150 bg-text hover:-translate-y-1 hover:scale-108 hover:bg duration-30">
